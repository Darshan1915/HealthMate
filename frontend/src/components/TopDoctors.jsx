        ...
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            ...
            <div className='w-full flex flex-wrap justify-center gap-4 pt-5 px-3 sm:px-0'>
                ...
                <div
                    ...
                    className='w-[100%] sm:w-[48%] md:w-[30%] lg:w-[20%] border border-[#C9D8FF] rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500'
                    key={index}>
